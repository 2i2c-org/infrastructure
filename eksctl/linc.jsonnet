/*
    ...
    To use jsonnet to generate an eksctl configuration file from this, do:
        ...
        jsonnet linc.jsonnet > linc.eksctl.yaml
...
local clusterRegion = "us-east-1";
local masterAzs = ["us-east-1a", "us-east-1b", "us-east-1c"];
local nodeAz = "us-east-1a";
...

{
    ...
    //
    //    eksctl create addon --config-file=linc.eksctl.yaml
    //
    addons: [
        {
    ...
    nodeGroups: [
        ng + {
            ...
            ssh: {
                publicKeyPath: 'ssh-keys/linc.key.pub'
            },
            instanceType: "r5.xlarge",
            minSize: 1,
            maxSize: 6,
