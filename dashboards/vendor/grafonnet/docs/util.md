...
* [`obj panel`](#obj-panel)
  ...
  * [`fn sanitizePanel(panel, defaultX=0, default=0, defaultHeight=8, defaultWidth=8)`](#fn-panelsanitizepanel)
...
```jsonnet
panel.sanitizePanel(panel, defaultX=0, default=0, defaultHeight=8, defaultWidth=8)
```
