...
- **JupyterHubs**.
  ...
  Configuration that is specific to each JupyterHub is stored in the [`config/clusters`](https://github.com/2i2c-org/infrastructure/tree/master/config/clusters) folder.
...
Many of our hubs are automatically deployed and updated using GitHub Workflows and configuration that is defined in [`infrastructure/config/clusters`](https://github.com/2i2c-org/infrastructure/tree/master/config/clusters).
...
4. Add a configuration entry for your new hub.
   ...
   For example, see the entries in [the 2i2c Google Cloud cluster configuration file](https://github.com/2i2c-org/infrastructure/blob/master/config/clusters/2i2c.cluster.yaml).
