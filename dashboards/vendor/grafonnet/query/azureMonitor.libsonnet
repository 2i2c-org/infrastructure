// This file is generated, do not manually edit.
{
  ...
  '#withResourceGroup': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Template variables params. These exist for backwards compatibility with legacy template variables.' } },
  withResourceGroup(value): {
    resourceGroup: value,
  },
