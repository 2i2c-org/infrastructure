...
Once nodes have started, you may wish to enable image pulling to ensure that the images required by users are available. See @enable-continuous-image-puller for details.
