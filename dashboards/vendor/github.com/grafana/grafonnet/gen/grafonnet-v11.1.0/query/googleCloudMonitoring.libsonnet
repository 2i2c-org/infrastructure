// This file is generated, do not manually edit.
{
  ...
  timeSeriesQuery+:
    {
      '#withGraphPeriod': { 'function': { args: [{ default: 'disabled', enums: null, name: 'value', type: ['string'] }], help: "To disable the graphPeriod, it should explicitly be set to 'disabled'." } },
